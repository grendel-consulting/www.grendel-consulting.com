...
We enforce <abbr title="HyperText Transfer Protocol Secure">HTTPS</abbr> on our website and <abbr title="Transport Layer Security">TLS</abbr> connections, conforming to TLS 1.3 or higher, across all communication channels.
